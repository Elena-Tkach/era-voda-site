...
if(!empty($_POST["kindWater"]) && is_array($_POST["kindWater"])) {$kind_water = implode(" ", $_POST['kindWater']);}
...
// if (isset($_POST['param_people']))			{$param_people			= $_POST['param_people'];		if ($param_people == '')		{unset($param_people);}}
...
// if (isset($_POST['pojelaniya_klient']))			{$pojelaniya_klient			= $_POST['pojelaniya_klient'];		if ($pojelaniya_klient == '')		{unset($pojelaniya_klient);}}
// if (isset($_POST['pojelaniya_water']))			{$pojelaniya_water			= $_POST['pojelaniya_water'];		if ($pojelaniya_water == '')		{unset($pojelaniya_water);}}
...
\nКак визуально выглядит исходная вода: $kind_water;";
